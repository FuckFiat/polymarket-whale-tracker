...
.float-number{{position:absolute;font-size:52px;font-weight:900;text-shadow:0 0 30px currentColor,0 0 60px currentColor;opacity:0;animation:floatUp 4s ease-out infinite}}
@keyframes floatUp{{0%{{opacity:0;transform:translateY(100vh) scale(0.3)}}10%{{opacity:1;transform:translateY(80vh) scale(1.5)}}25%{{opacity:0.95;transform:translateY(55vh) scale(1.2)}}50%{{opacity:0.6;transform:translateY(30vh) scale(0.9)}}100%{{opacity:0;transform:translateY(-5vh) scale(0.2)}}}}
...
.pnl-hero .pnl-value{{font-size:72px;font-weight:700;margin-top:8px;transition:all .8s cubic-bezier(.2,1,.3,1);animation:pnlGlow 2s ease-in-out infinite alternate}}
.pnl-hero .pnl-value.positive{{color:#00ff88;text-shadow:0 0 40px #00ff8866,0 0 80px #00ff8833}}
.pnl-hero .pnl-value.negative{{color:#ff4444;text-shadow:0 0 40px #ff444466,0 0 80px #ff444433}}
.pnl-hero .pnl-details{{font-size:13px;color:#888;margin-top:12px;letter-spacing:1px}}
.pnl-hero .pnl-details span{{margin:0 12px}}
@keyframes pnlGlow{{0%{{filter:brightness(1)}}100%{{filter:brightness(1.2)}}}}
